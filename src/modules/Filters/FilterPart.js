...
function FilterPart(props) {
  ...
  return (
    <div className="ps-section">
      <div className="info-box filters-wrapper">
        <div className="info-wrapper">
          {/* <StyleSelect
            title={formtrans.category[props.lang]}
            ...
            class={"formInput"}
            action={(e) =>
              props.setFilterChange((prevState) => ({
                ...prevState,
                category: e,
              }))
            }
          ...
          <div className="optionsSelect">
            {optionShow ? (
              <StyleInput
                title={formtrans.options[props.lang]}
                direction={props.direction}
                value={optionSelect}
                class={"formInput"}
          ...
          {/* <StyleInput
            title={formtrans.optionsN[props.lang]}
            direction={props.direction}
            defaultValue={data ? data.optionsN : ""}
            class={"formInput"}
            action={(e) =>
              props.setFilterChange((prevState) => ({
                ...prevState,
