...
function CatDetails(props) {
  ...
  return (
    <div className="serviceItem">
      ...
      />
      <StyleInput
        title={formtrans.link[props.lang]}
        direction={props.direction}
        defaultValue={content ? content.link : ""}
        class={"formInput"}
        action={(e) =>
          props.setCatChange((prevState) => ({
            ...prevState,
      ...
      />
      <StyleInput
        title={formtrans.catCode[props.lang]}
        direction={props.direction}
        defaultValue={content ? content.catCode : ""}
        class={"formInput"}
        action={(e) =>
          props.setCatChange((prevState) => ({
            ...prevState,
      ...
      />
      <StyleSelect
        title={formtrans.catParent[props.lang]}
        direction={props.direction}
        options={options || []}
        defaultValue={content ? content.parent : ""}
        class={"formInput"}
        label="title"
        action={(e) =>
          props.setCatChange((prevState) => ({
      ...
      />
      <StyleSelect
        title={formtrans.status[props.lang]}
        direction={props.direction}
        options={[
